...
from ecr.views import index, analyze, api, promoter, protein, transcript, documentation, suggestions
...
urlpatterns = [
    ...
    re_path(r'^documentation/$', documentation, name='documentation'),
    re_path(r'^suggestions/$', suggestions, name='suggestions'),
